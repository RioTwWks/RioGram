...
> **Статус (август 2026):** MVP в основном реализован (этапы 1–4 и большая часть 5). Инфраструктура прокси и полевые DPI-тесты — в процессе.  
> Детальный чеклист — [TODO.md](TODO.md). Документация — [docs/](docs/).
...
| 6. Паритет функционала | §6 | 🔜 После закрытия MVP |
...
- [x] Авторизация по номеру телефона (phone → code → 2FA).
