...
| 7. Дизайн «классический TG» | §9 | ✅ Токены, §9.11 pixel parity; ручная сверка §9.11.9 |
...
| §9 Классический дизайн (до Liquid Glass) | ✅ | [docs/DESIGN.md](docs/DESIGN.md), [RELEASE_NOTES_1.1.0.md](docs/RELEASE_NOTES_1.1.0.md) |
...
| [docs/DESIGN.md](docs/DESIGN.md) | Дизайн §9: токены, `telegramTheme`, анти-паттерны |
| [docs/RELEASE_NOTES_1.1.0.md](docs/RELEASE_NOTES_1.1.0.md) | Release notes визуального редизайна |
