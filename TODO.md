...
### 9.11. Иконки Telegram-style (P1)

- [x] Централизованный маппинг `lib/core/theme/telegram_icons.dart` (Material outlined, 24dp)
- [x] Иконки навигации, панели ввода, AppBar переписки, preview в списке чатов
- [x] Галочки доставки: отправлено (1), доставлено (2 серые), прочитано (2 синие)
