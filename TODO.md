...
**Последнее обновление:** §9 / §9.11 классический дизайн Telegram — docs/DESIGN.md, RELEASE_NOTES_1.1.0, `.cursor/`.
...
- [x] Индикатор «печатает…» / «записывает голосовое…» в preview
- [x] Префикс имени отправителя в групповых чатах (`User:`)
- [x] Вертикальное выравнение времени и badge при одной строке preview
- [x] Hover / selected state на Desktop — цвет `#3390EC` @ 8% (сверка оттенка)
- [x] FAB отступ снизу 16px + safe area (mobile)
