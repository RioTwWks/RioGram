...
### 9.11. Composer polish (P3)

- [x] **#13** Одна кнопка «Прикрепить» (без дубля слева и в pill); attach sheet снизу вместо PopupMenu
- [x] **#14** Голосовое: цвет play/waveform по контексту пузыря, не всегда accent
